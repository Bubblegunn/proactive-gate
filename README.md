...
calendar year, a rewound clock, and years below 1000, where the two implementations
currently disagree and say so through `spec/skip/`. The TypeScript tests and the
...
|---|---|---:|---|
| TypeScript | 1.4.1 | 55 of 57 | clock/year-under-1000 (localClock formats years < 1000 unpadded ("1-06-01"), so weekdayOf remaps the year through Date.UTC (0-99 mean 1900s) and dayBefore/dates lookups miss; upstream bug #36); clock/year-under-1000-week (isoWeekKey parses "1-06-01T00:00:00Z" as Invalid Date, producing NaN-WNaN instead of the spec-format 0001-W22; upstream bug #36) |
| Python | 1.4.1 | 55 of 57 | clock/year-under-1000 (strftime %Y padding is build-dependent; on non-padding builds local_clock emits "1-06-01", the strict-ISO helpers throw, and every clock check fails open; upstream bug #38); clock/year-under-1000-week (iso_week_key formats the ISO year unpadded ("1-W22") where the spec format is 0001-W22, and on non-padding builds it throws on the unpadded day string; upstream bugs #37 and #38) |
<!-- conformance:end -->
